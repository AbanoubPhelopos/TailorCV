...
using TailorCV.Modules.Identity.Users.AssignRole;
using TailorCV.Modules.Identity.Users.GetById;
using TailorCV.Modules.Identity.Users.Login;
using TailorCV.Modules.Identity.Users.Register;
...
namespace TailorCV.Api.Controllers;
