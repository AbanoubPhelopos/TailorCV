...
public class JobDescriptionConfiguration : IEntityTypeConfiguration<Domain.JobDescription>
{
    public void Configure(EntityTypeBuilder<Domain.JobDescription> builder)
    {
        builder.ToTable("job_descriptions", "jobdescriptions");
